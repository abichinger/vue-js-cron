...
test('test strToArray', () => {
    ...
    expect(strToArray('5/10', r(8, 59))).toEqual([15, 25, 35, 45, 55]);
    expect(strToArray('3/8', r(7, 59))).toEqual([11, 19, 27, 35, 43, 51, 59]);
...
test('test arrayToStr', () => {
    ...
    expect(arrayToStr([15, 25, 35, 45, 55], r(10, 59)).value).toEqual('15/10');
});
